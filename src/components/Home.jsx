    ...
    <line x1="3" y1="18" x2="21" y2="18" />
      ...
      <div className='container w-full h-[499px] flex flex-col items-center justify-center'>
        <div className='text-center'>
          <p className='text-[28px] font-normal font-jakarta'>India's</p>
        </div>
        <div className='flex flex-col items-center justify-center w-full'>
          <div className='w-full h-[250px] flex flex-col items-center justify-center'>
            <p className='text-[150px] font-extrabold font-anton font-Medium'>10,000</p>
            <p className='text-[40px] font-normal font-anton'>STEP APP</p>
          </div>
          <div className='w-full h-[105px] mt-8 flex justify-center items-center  ml-[10rem]'>
            <p className='font-medium text-[24px] w-[550px]  text-center text-pure-greys-10 font-jakarta '>
              We are not step trackers but step enablers. On a mission to build India's most sincere fitness community.
            </p>
            <div className=''>
              <img src={ButtonJoinUs} alt='Join Us' className='w-[168px] h-[168px] ml-10 mt-11' />
            </div>
          </div>
        </div>
      </div>
      <div className='flex justify-start '>
        <img src={Scanner} alt='' className='ml-5 mb-10'/>
